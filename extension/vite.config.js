...
export default defineConfig(({ mode }) => {
  ...
  const envDefines = {
    ...
    'process.env.NEXT_PUBLIC_EXPLORER_WALLET_MAINNET_URL': JSON.stringify(env.VITE_EXPLORER_WALLET_MAINNET_URL || 'https://charms-explorer-api.fly.dev'),
    'process.env.NEXT_PUBLIC_EXPLORER_WALLET_TESTNET4_URL': JSON.stringify(env.VITE_EXPLORER_WALLET_TESTNET4_URL || ''),
    ...
    'process.env.NEXT_PUBLIC_MEMPOOL_API_URL': JSON.stringify(env.VITE_MEMPOOL_API_URL || 'https://mempool.space/testnet4/api'),
    // Cardano (optional)
