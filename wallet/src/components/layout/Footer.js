                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-5">
                            <a
                                ...
                                className="text-dark-400 hover:text-bitcoin-400 transition-colors text-sm"
                            >
                                Charms Protocol
                            </a>
                            <a
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                className="text-dark-400 hover:text-bitcoin-400 transition-colors p-1 rounded-lg hover:bg-dark-700/50"
                                title="Configuration"
                            >
